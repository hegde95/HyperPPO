...
_params = ParamGrid(
    [
        ("seed", seeds(5)),
        ("env", ["halfcheetah"]),  #["ant", "humanoid", "halfcheetah", "walker2d"]
    ]
)

vstr = f"brax_hyper_benchmark"

cli = "python -m sf_examples.brax.train_hyper_brax --with_wandb=True --wandb_tag hc_0"
