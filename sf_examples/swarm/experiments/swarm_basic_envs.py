...
cli = "python -m sf_examples.swarm.train_swarm --with_wandb=True --wandb_tag paper_bench_swarm_neweval2 --hyper False --wandb_user khegde --wandb_group drones_actual_neweval2 --train_for_env_steps 1_000_000_000 --meta_batch_size 16 --continuous_tanh_scale 5"
